...
use Modules\Common\UI\Table\Action;
use Modules\Common\UI\Table\Batch;
use Modules\Common\UI\Table\Column;
use Modules\Common\UI\Table\Filter;
use Modules\Common\UI\Table\FilterType;
...
class Table
{
    ...
    {
        $filter = new \Modules\Common\UI\Table\Filter($name, $field, $where);
    ...
    {
        $filterType = new \Modules\Common\UI\Table\FilterType($name, $where, $url);
    ...
    public function export(callable $callback)
    {
        ...
        $data = $this->query->get();
        // 执行渲染输出
        $export = new \Modules\Common\UI\Table\Export();
        $callback($export);
        $export->render($data);
    }
